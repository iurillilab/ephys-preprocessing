...
from neuroconv.datainterfaces import KiloSortSortingInterface, OpenEphysRecordingInterface, SLEAPInterface
...
def spikes_interface_loder(folder_path: Path, overwrite: bool = False) -> pd.DataFrame:
